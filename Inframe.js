function go_to_player(url) {
    ...
    document.querySelector(".BotHumano")
        .insertAdjacentHTML('afterbegin', '<div class="BoxHumano"><span><b>Procesando vÃƒÂ­deo</b> <p>Por favor espere unos segundos</p></span></div>');
    ...
    <span id="backToPlayers" onclick="listPlayer();">
        <img src="https://i.ibb.co/nQbF3qm/CITYPNG-COM-Transparent-Handdrawn-Doodle-Red-X-Close-Icon-552x469.png">
    </span>
